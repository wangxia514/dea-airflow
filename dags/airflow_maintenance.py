...
from dea_airflow_common.utils import days_ago
...
START_DATE = days_ago(1, timezone="Australia/Sydney")
...
DEFAULT_MAX_DB_ENTRY_AGE_IN_DAYS = 180
...
def cleanup_function(**context):
    """Clean out old records from an Airflow Table"""
