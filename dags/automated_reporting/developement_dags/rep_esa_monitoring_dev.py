...
with dag:
    ...
    syn_l1_nrt_download = KubernetesPodOperator(
        namespace="processing",
        image=ETL_IMAGE,
        arguments=["bash", "-c", " &&\n".join(SYN_L1_NRT_DOWNLOAD_TASK)],
        name="syn_l1_nrt_download",
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    syn_l1_nrt_ingestion = KubernetesPodOperator(
        namespace="processing",
        image=ETL_IMAGE,
        arguments=["bash", "-c", " &&\n".join(SYN_L1_NRT_INGESTION_TASK)],
        name="syn_l1_nrt_ingestion",
        is_delete_operator_pod=True,
        in_cluster=True,
