...
"""
aws cost stats dag for sandbox account
"""
...
dag = DAG(
    "rep_aws_cost_stats_prod_ga_dea_sandbox",
    description="DAG for aws cost stats dea-sandbox",
    tags=["reporting"],
...
with dag:
    aws_s3_cost_stats_ingestion = utilities.k8s_operator(
        ...
        secrets=k8s_secrets.db_secrets(ENV) + k8s_secrets.iam_sandbox_secrets,
    )
