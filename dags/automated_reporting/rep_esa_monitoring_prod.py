...
with dag:
    ...
    SCIHUB_ACQS_TASK = [
        ...
        "jsonresult=`python3 -c 'from nemo_reporting.esa_monitoring import s2_acquisitions; s2_acquisitions.task_env()'`",
    ...
    insert_s2_acquisitions = KubernetesPodOperator(
        ...
        env_vars={
            "S3_CREDENTIALS": S3_CREDENTIALS_STR,
            "DB_CREDS": REP_CONN_STR,
            "S3_OBJECT_NAME": "{{ task_instance.xcom_pull(task_ids='scihub_s2_acquisitions', key='s3_object') }}",
        },
    )
