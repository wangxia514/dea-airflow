...
from infra.variables import AWS_STATS_SECRET_MASTER
...
default_args = {
    ...
    "secrets": [
        Secret("env", "ACCESS_KEY", AWS_STATS_SECRET_MASTER, "ACCESS_KEY"),
        Secret("env", "SECRET_KEY", AWS_STATS_SECRET_MASTER, "SECRET_KEY"),
        Secret("env", "DB_HOST", AWS_STATS_SECRET_MASTER, "DB_HOST"),
        Secret("env", "DB_USER", AWS_STATS_SECRET_MASTER, "DB_USER"),
        Secret("env", "DB_PASSWORD", AWS_STATS_SECRET_MASTER, "DB_PASSWORD"),
    ],
}
