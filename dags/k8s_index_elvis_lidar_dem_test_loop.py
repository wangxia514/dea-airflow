...
ADD_METADATA_TYPE_CMD = [
    ...
    dedent(
        """
        datacube metadata update https://raw.githubusercontent.com/GeoscienceAustralia/dea-config/feature/add-elvis-dem_1m/product_metadata/eo3_dem.odc-type.yaml --allow-unsafe
        """
    ),
]
