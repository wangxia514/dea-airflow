...
DEFAULT_ARGS = {
    ...
    "secrets": [
        ...
        Secret("env", "AWS_DEFAULT_REGION", "processing_user_creds_dev", "AWS_DEFAULT_REGION"),
        Secret("env", "AWS_ACCESS_KEY_ID", "processing_user_creds_dev", "AWS_ACCESS_KEY_ID"),
        Secret("env", "AWS_SECRET_ACCESS_KEY", "processing_user_creds_dev", "AWS_SECRET_ACCESS_KEY"),
    ],
}
