...
WAGL_IMAGE = (
    "451924316694.dkr.ecr.ap-southeast-2.amazonaws.com/dev/wagl:patch-20201015-1"
)
...
with pipeline:
    ...
    COPY = KubernetesPodOperator(
        ...
        cmds=[
            ...
            "aws sts get-caller-identity; date > somefile; aws cp somefile s3://dea-public-data-dev/L2/sentinel-2-nrt/S2MSIARD",
        ],
