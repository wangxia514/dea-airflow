...
def k8s_queueread(dag, branch):
    ...
    return KubernetesPodOperator(
        ...
        labels={"app": "waterbodies-all-queueread"},
        get_logs=True,
        affinity=affinity,
                    ...
                    "containers": [
                        {
                            ...
                            "args": [
                                ...
                                python -m dea_waterbodies.make_time_series -vv --config config.ini --from-queue {queue}
                                """.format(
                                        queue=f"waterbodies_{branch}_sqs",
                                        config=config_path,
                                    )
...
def k8s_makequeue(dag, branch):
    ...
    makequeue = KubernetesPodOperator(
        ...
        image_pull_policy="IfNotPresent",
        labels={"app": "waterbodies-dev-all-makequeue"},
        get_logs=True,
        affinity=affinity,
        is_delete_operator_pod=True,
        resources={
...
def k8s_delqueue(dag, branch):
    ...
    delqueue = KubernetesPodOperator(
        ...
        image_pull_policy="IfNotPresent",
        labels={"app": "waterbodies-dev-all-delqueue"},
        get_logs=True,
        affinity=affinity,
        is_delete_operator_pod=True,
        resources={
