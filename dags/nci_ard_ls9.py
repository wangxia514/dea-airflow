...
params = {
    ...
    "config_arg": "",
    "scene_limit": "--scene-limit 4000",
    "interim_days_wait": "--interim-days-wait 18",
    "products_arg": """--products '["usgs_ls9c_level1_2"]'""",
...
# sed '/#\/\*/,/#\*\// d' nci_ard_ls9.py > ../../nci_ard_ls9.py
# sed '/#\/\*/,/#\*\// d' dags/nci_ard_ls9.py > ../nci_ard_ls9.py
# mv ../nci_ard_ls9.py dags/nci_ard_ls9.py
# params[""] =
...
if aws_develop:
    ...
    # A fail safe
    params["scene_limit"] = "--scene-limit 20"
