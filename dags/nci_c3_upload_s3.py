...
LIST_SCENES_COMMAND = """
    ...
    AND ds.added > current_date - interval '1 day' 
    limit 2 
    ;"
    output_file={{ work_dir }}/{{ params.product }}.txt
...
with dag:
    for product in collection3_products:
        ...
        sftp_c3_to_s3_script = SFTPOperator(
            ...
            ).joinpath("scripts/c3_to_s3_rolling.py").as_posix(),
