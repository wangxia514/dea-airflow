...
default_args = {
    ...
    'start_date': datetime(2015, 7, 12, tzinfo=local_tz),
    'retries': 1,
...
with dag:
    ...
    upload_uploader_script = SFTPOperator(
        ...
        local_filepath=str(Path(configuration.get('core', 'dags_folder')).parent / "scripts/s2b_fix_metadata.py"),
    ...
    execute_upload = SSHOperator(
        ...
        command=dedent(COMMON + """
            ...
            python3 '{{ work_dir }}/s2b_fix_metadata.py' {{ ds }} 
            """),
