...
from dags.sentinel_2_nrt.images import OWS_CFG_IMAGEPATH, OWS_CONFIG_IMAGE, OWS_IMAGE
from dags.sentinel_2_nrt.env_cfg import OWS_CFG_PATH, OWS_CFG_MOUNT_PATH
