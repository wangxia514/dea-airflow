...
def process_dataset(s3_obj):
    ...
    nci_path = os.path.join(NCI_DIR, granule, "ARD-METADATA.yaml")
    ...
    s3_eo3_path = s3_eo3_path.replace("dea-public-data", "dea-public-data-dev")
    s3_stac_path = s3_stac_path.replace("dea-public-data", "dea-public-data-dev")
